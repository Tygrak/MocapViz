...
function update() {
    ...
    drawFrame(currentPlayingFrames[currentFrame], width/2);
    //drawFrame(swapFrameXZ(currentPlayingFrames[currentFrame]), width/2);
    currentFrame++;
